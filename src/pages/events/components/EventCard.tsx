...
const EventCard = (props: Props): JSX.Element => {
  return (
    <div className="bg-white shadow-eventCardShadow h-[550px] w-[350px] overflow-hidden shadow-lg shadow-darkbtn rounded-xl transform hover:scale-105 transition duration-700 ease-in-out mx-auto">
      <img
        draggable={false}
      ...
      <div className="flex mt-3 mb-1">
        ...
        <article className="pl-5 mt-3 mb-6">
          ...
          <span className="flex pl-0 text-left">
            <img src={Vector} title="vector" className="h-[17.5px] w-[14px]" />
            &nbsp;&nbsp;&nbsp;{props.location}
          </span>
        </article>
      </div>
