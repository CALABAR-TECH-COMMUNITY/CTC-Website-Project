      ...
      <figure className="flex flex-wrap gap-x-4 gap-y-8 max-w-4xl mx-auto justify-center lg:justify-start mt-14">
        {images.map(({ alt, src }, index) => {
          return (
            <div
              key={index}
              className="bg-white h-24 w-44 md:w-48 md:h-28  lg:h-32 lg:w-52 shadow-sponsorsCardShadow flex items-center justify-center rounded-lg border-t-8 border-t-appGray200"
            >
              <img
