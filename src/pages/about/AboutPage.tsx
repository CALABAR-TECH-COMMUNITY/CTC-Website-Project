    ...
    return(
        <>
          <div className="hero" style={{backgroundImage: `url(${background})`, backgroundRepeat: 'no-repeat', backgroundSize: 'contain', height: '300px' }}>
            <div className="hero-text-bg" style={{backgroundImage: `url(${textbg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'contain', width: '146px', height: '71px', opacity: '80%', position: 'absolute', top: '70px', left: '68px'   }}>
              <h1>about us</h1>
            </div>
          </div>
