...
const HomeLayout = ({ children, hideNav }: LayoutProps) => {
      ...
      <footer className="bg-[var(--c-bg-color-2)] text-white pt-8">
        <div className="w-[80%] m-auto pt-[3%] md:flex md:justify-around flex flex-col md:flex-row text-center md:text-start">
          ...
          <div className="text-[var(--cc-grey-3)]">
            <h2 className="font-[700] text-[20px] mb-4 mt-8 md:mt-0">
              Social Media
            </h2>
        ...
        <div className=" md:flex md:justify-around flex flex-col md:flex-row text-center md:text-start mt-14 mb-2 py-2 text-[var(--cc-grey-3)] ">
          <span className="md:ml-[7%] md:w-[10%] mb-4 md:mb-0 md:mt-6 font-[500] text-[12px]">
            &copy; 2023{" "}
          </span>
